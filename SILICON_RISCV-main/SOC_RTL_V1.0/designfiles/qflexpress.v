...
//2......Synthesizable : Added function "init_command" to mimic the startup logic (the original code uses inital block for the same, which is not synthesizable)
...
`endif
	...
	begin :GEN_OPT_ODDR// Flash clock == system clock speed
		// {{{
...
// function for commnad sequence indexing

function automatic [10:0]init_command;
input [4:0]index;
begin
case(index)
5'h08: init_command={ 1'b0, NORMAL_SPI, 8'hff }; 
5'h09: init_command={ 1'b0, NORMAL_SPI, 8'hff };
5'h0a: init_command={ 1'b0, NORMAL_SPI, 8'hff };
5'h0b: init_command={ 1'b1, 10'h3f };
5'h0c: init_command={ 1'b0, NORMAL_SPI, 8'h06 };
5'h0d: init_command={ 1'b1, 10'h3ff };
5'h0e: init_command={ 1'b0, NORMAL_SPI, 8'h31 };
5'h0f: init_command={ 1'b1, NORMAL_SPI, 8'h00 };
5'h10: init_command={ 1'b0, NORMAL_SPI, 8'h02 };
5'h11: init_command={ 1'b1, 10'h3ff };
5'h12: init_command={ 1'b1, 10'h3ff };
5'h13: init_command= { 1'b0, NORMAL_SPI, 8'h04 };
5'h14: init_command={ 1'b1, 10'h3ff };
5'h15: init_command=  { 1'b0, NORMAL_SPI, 8'heb };
5'h16: init_command= { 1'b0, QUAD_WRITE, 8'h00 };
5'h17: init_command= { 1'b0, QUAD_WRITE, 8'h00 };
5'h18: init_command= { 1'b0, QUAD_WRITE, 8'h00 };
5'h19: init_command= { 1'b0, QUAD_WRITE, 8'ha0 };
5'h1a: init_command= { 1'b0, QUAD_WRITE, 8'h00 };
5'h1b: init_command= { 1'b0, QUAD_WRITE, 8'h00 };
5'h1c: init_command={ 1'b0, QUAD_WRITE, 8'h00 };
5'h1d: init_command={ 1'b0, QUAD_READ, 8'h00 };
5'h1e: init_command=11'h7ff;
5'h1f: init_command= 11'h7ff;
default:  init_command= 11'h7ff;
...
/*		integer k;
		...
		m_cmd_word[5'h0e] = { 1'b0, NORMAL_SPI, 8'h31 };	// WRR
		m_cmd_word[5'h0f] = { 1'b1, NORMAL_SPI, 8'h00 };	// status register
		...
		always @(posedge i_clk)
		if (new_word)
			m_this_word <=init_command(m_cmd_index);
			//m_this_word <=m_cmd_word[m_cmd_index]; //uncomment if command sequence is initialized in the above initial block provided by author.
		// }}}
